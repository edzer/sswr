...
1. Copy the course material from GitHub to your local machine
2. Open it in RStudio
3. Open the `day1.qmd` file. Try to identify a code chunk.
4. Run the first code chunk.
5. Skip to the last code chunk; run all code chunks above it (by a single click), and then run this last code chunk.
