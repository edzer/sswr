...
[https://spatialstatis-7gb9460.slack.com](slack channel)
...
* Reproduce these course materials by 
    * installing [quarto](https://quarto.org/) and 
	* running `quarto render` in the course directory
