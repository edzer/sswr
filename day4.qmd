...
* how would the predicted surface look like when instead of (functions of) coordinates, the variable _elevation_ were used (e.g. to predict average temperatures)?
* what would be the value range, approximately, of the predicted values? 
...
* How could you assess whether residuals from your fitted model are spatially correlated?
* Does random cross validation assume that observations are independent?
