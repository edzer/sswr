...
Another package is [GPBoost](https://cran.r-project.org/web/packages/gpboost/index.html), an R package that allows for combining tree-boosting with Gaussian process and mixed effects models; package also has a [Python implementation](https://github.com/fabsig/GPBoost).
